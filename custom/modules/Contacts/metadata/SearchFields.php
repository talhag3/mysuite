...
$searchFields['Contacts'] = array (
  ...
  array(
    'query_type' => 'default',
    'operator' => 'subquery',
    'subquery' => 'SELECT pt_contacts.id from contacts as pt_contacts INNER JOIN aos_contracts on aos_contracts.contact_id=pt_contacts.id and aos_contracts.deleted=0 where aos_contracts.contract_type LIKE',
    'db_field' => 
    array (
      0 => 'id',
    ),
